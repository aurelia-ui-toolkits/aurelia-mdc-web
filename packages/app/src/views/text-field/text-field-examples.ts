...
import iconsHtml from '!!raw-loader!./icons/icons.html?raw';
import counterHtml from '!!raw-loader!./counter/counter.html?raw';
import densityHtml from '!!raw-loader!./density/density.html?raw';
import densityScss from '!!raw-loader!./density/density.scss';
import eventsHtml from '!!raw-loader!./events/events.html?raw';
import noLabelHtml from '!!raw-loader!./no-label/no-label.html?raw';
import numericHtml from '!!raw-loader!./numeric/numeric.html?raw';
import prefixSuffixHtml from '!!raw-loader!./prefix-suffix/prefix-suffix.html?raw';
import prefilledHtml from '!!raw-loader!./prefilled/prefilled.html?raw';
import rtlHtml from '!!raw-loader!./rtl/rtl.html?raw';
import shapeHtml from '!!raw-loader!./shape/shape.html?raw';
import shapeScss from '!!raw-loader!./shape/shape.scss';
import svgIconHtml from '!!raw-loader!./svg-icon/svg-icon.html?raw';
import textareaHtml from '!!raw-loader!./textarea/textarea.html?raw';
import textareaScss from '!!raw-loader!./textarea/textarea.scss';
import typesHtml from '!!raw-loader!./types/types.html?raw';
...
import blurOnEnterHtml from '!!raw-loader!./blur-on-enter/blur-on-enter.html?raw';
