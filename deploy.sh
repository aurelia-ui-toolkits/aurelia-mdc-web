...
parse_args() {
	...
	deploy_directory=${GIT_DEPLOY_DIR:-packages/app/dist}
...
main() {
	...
	if [ ! -d "$deploy_directory" ]; then
		echo "Deploy directory '$deploy_directory' $GIT_DEPLOY_DIR does not exist. Aborting." >&2
		return 1
	fi
